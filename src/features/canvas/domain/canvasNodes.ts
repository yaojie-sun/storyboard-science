...
import type { SceneMarker } from './sceneMarker';
...
export interface StoryboardGenNodeData {
  ...
  /** URL to the last generated video for this node (set by VideoGenDialog on success) */
