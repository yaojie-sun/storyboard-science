...
const DEFAULT_RULES: VideoGenRules = {
  ...
  constraints: {
    ...
    hard_constraints: [
      ...
      'Each shot lasts ≥1.5 seconds — no flash cuts, no blink-and-miss frames.',
    ],
  },
};
