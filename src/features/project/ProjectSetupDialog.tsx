          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <PresetPicker presets={SCIENCE_STYLE_PRESETS} value={directorRef} onChange={setDirectorRef} placeholder="输入自定义风格..." />
              </div>
            </div>
